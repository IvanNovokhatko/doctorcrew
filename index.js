import{a as q,S as O,N as X,P as D,A as G}from"./assets/vendor-BeKveIiU.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const d of a.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function s(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=s(o);fetch(o.href,a)}})();const r=document.querySelector(".burger-btn"),b=document.querySelector(".nav-wrapper"),c=document.querySelector(".menu-overlay");if(r&&b){const e=()=>{r.classList.add("is-open"),b.classList.add("is-open"),c==null||c.classList.add("is-open"),r.setAttribute("aria-expanded","true"),document.body.style.overflow="hidden"},t=()=>{r.classList.remove("is-open"),b.classList.remove("is-open"),c==null||c.classList.remove("is-open"),r.setAttribute("aria-expanded","false"),document.body.style.overflow=""};r.addEventListener("click",()=>{r.classList.contains("is-open")?t():e()}),b.querySelectorAll(".nav-link, .header-btn").forEach(s=>{s.addEventListener("click",t)}),c==null||c.addEventListener("click",t),document.addEventListener("keydown",s=>{s.key==="Escape"&&r.classList.contains("is-open")&&(t(),r.focus())})}const B=document.querySelector(".pets-section__filter-list"),V=document.querySelector(".pets-section__pets-list"),z=document.querySelector(".pets-section__button"),I=["Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];let l=8,f;const R=e=>{const t=[...e].sort((s,i)=>I.indexOf(s.name)-I.indexOf(i.name)).map(s=>`<li class="filter-list__item">
    ...
    </li>`).join("");V.insertAdjacentHTML("beforeend",t)},Q=async()=>{try{const e=await q.get("https://paw-hut.b.goit.study/api/categories");R(e.data)}catch(e){console.error(e)}},L=async e=>{try{const t=await q.get("https://paw-hut.b.goit.study/api/animals",e);V.innerHTML="",K(t.data.animals)}catch(t){console.error(t)}},Z=e=>{Q()},J=e=>{e.target.classList.contains("filter-list__button")&&(z.classList.remove("is-hidden"),B.querySelectorAll(".filter-list__button").forEach(t=>{t.classList.remove("is-active")}),window.matchMedia("(min-width: 1440px)").matches?l=9:l=8,e.target.classList.add("is-active"),f=e.target.dataset.id,f==="all"?L({params:{limit:l}}).catch(t=>{console.log(t)}):L({params:{limit:l,categoryId:f}}).catch(t=>{console.log(t)}))},U=e=>{z.classList.remove("is-hidden"),window.matchMedia("(min-width: 1440px)").matches?l=9:l=8,f==="all"?L({params:{limit:l}}).catch(t=>{console.log(t)}):L({params:{limit:l,categoryId:f}}).catch(t=>{console.log(t)})};document.addEventListener("DOMContentLoaded",Z);B.addEventListener("click",J);window.addEventListener("resize",U);const Y=document.querySelector(".pets-section__pets-list"),x=document.querySelector(".pets-section__button");let m=document.querySelector(".filter-list__button.is-active"),u=8,h=m.dataset.id,p=1,T,j=500;const ee=e=>{const t=[...e].map(s=>`<li class="pets-list__item">
      <img src="${s.image}" alt="${s.name}" class="pets-list__image" />
      <p class="pets-list__species">${s.species}</p>
      <p class="pets-list__name">${s.name}</p>
  ...
  `}async function ne(){const e=await oe(),t=document.querySelector("#feedbacks-list");t.innerHTML=e.map(ae).join("")}document.addEventListener("DOMContentLoaded",async()=>{await ne(),new O(".swiper__success-swiper",{modules:[X,D],slidesPerView:1,slidesPerGroup:1,spaceBetween:20,navigation:{nextEl:".success-swiper__button-next",prevEl:".success-swiper__button-prev"},pagination:{el:".success-swiper__pagination",clickable:!0},breakpoints:{768:{slidesPerView:2,slidesPerGroup:2,spaceBetween:32}}})});const re=document.querySelector(".modal-overlay"),ce=document.querySelector(".pets-section__pets-list"),P=document.querySelector("body"),F=document.querySelector(".animal-modal"),g=document.querySelector(".animal-modal-backdrop");let n;const E=()=>{P.classList.remove("no-scroll"),g.classList.remove("is-open"),setTimeout(()=>{F.innerHTML=""},250)},le=()=>{const e=()=>`<button class="animal-modal__animal-close-button is-animal-close-button">
